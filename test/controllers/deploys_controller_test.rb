...
class DeploysControllerTest < ActionController::TestCase
  ...
  test "should create deploy" do
    assert_difference('Deploy.count') do
      post :create, deploy: { ^: @deploy.^, create: @deploy.create, migration: @deploy.migration, tag: @deploy.tag }
    end
  ...
  test "should update deploy" do
    patch :update, id: @deploy, deploy: { ^: @deploy.^, create: @deploy.create, migration: @deploy.migration, tag: @deploy.tag }
    assert_redirected_to deploy_path(assigns(:deploy))
  end
